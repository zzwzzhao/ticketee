...
describe "/apis/v2/tickets", :type => :api do
  ...
  context "index" do
    ...
    let(:url) { "/apis/v2/projects/#{project.id}/tickets" }
  ...
  context "pagination" do
    ...
    it "gets the first page" do
      get "/apis/v2/projects/#{project.id}/tickets.json",
      :token => token, :page => 1
    ...
    it "gets the second page" do
      get "/apis/v2/projects/#{project.id}/tickets.json?page=2",
      :token => token, :page => 2
